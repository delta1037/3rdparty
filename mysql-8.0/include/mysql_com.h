...
/**
  ...
  Common definition between mysqlpp server & client.
*/
...
/*
  We need a definition for my_socket. On the client, <mysqlpp.h> already provides
  it, but on the server side, we need to get it from a header.
*/
#ifndef my_socket_defined
#include "my_io.h"
#include "mysqlpp/components/services/my_io_bits.h"
#endif
...
#define REFRESH_MASTER                                                 \
  128                            /**< Remove all lib logs in the index \
