...
/*
  ...
  even if mysqlpp.h doesn't use this information directly.
*/
...
typedef struct MYSQL_STMT {
  ...
  */
  ...
  /* copy of mysqlpp->affected_rows after statement execution */
  uint64_t affected_rows;
  uint64_t insert_id;          /* copy of mysqlpp->insert_id */
  unsigned long stmt_id;       /* Id for prepared statement */
  unsigned long flags;         /* i.e. type of cursor to open */
  unsigned long prefetch_rows; /* number of rows per one COM_FETCH */
  /*
    Copied from mysqlpp->server_status after execute/fetch to know
